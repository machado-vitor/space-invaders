...
# box = pygame.image.load(pathlib.Path(__file__).with_name("ship.png")).convert()
box.fill("gold")
...
while True:
    ...
    screen.fill("black")
    screen.blit(box, box_rect, special_flags=pygame.BLEND_ALPHA_SDL2) # Blit the box on the screen
